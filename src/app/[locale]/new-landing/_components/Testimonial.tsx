...
export function Testimonial({
	...
	return (
		<aside
			...
			className="relative bg-slate-100 py-16 sm:py-32 border"
		>
			<div className="text-slate-900/10">
				<GridPattern x="50%" patternTransform="translate(0 80)" />
			</div>
			<Container size="xs" className="relative bg-slate-50 border rounded-xl py-16">
				<figure>
					<div className="flex text-slate-900 sm:justify-center">
						<StarRating />
					</div>
					<blockquote className="mt-6 font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-center text-balance">
						{children}
					</blockquote>
