...
export default function MentorsPage() {
	const mentors = [
		...
		{
			name: "Leo Exter",
			title: "Startup Ecosystem Builder & Corporate Innovation Leader",
			image: "/images/mentors/leo-exter.jpg",
			experience: "20+ years",
			companies: 5,
			linkedin: "https://www.linkedin.com/in/leoexter/",
			bio: "Leo Exter is a long-time champion of the Belgian startup ecosystem, founder of Westartup, and co-founder of Hack Belgium Labs. He has advised hundreds of founders while helping corporates design innovation programs, intrapreneurship tracks, and open-innovation challenges that lead to tangible ventures. Leo brings deep expertise in facilitating collaborative innovation between startups, governments, and enterprise partners across Europe.",
		},
		{
