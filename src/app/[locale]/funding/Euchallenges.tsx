			...
			<div className="mx-auto max-w-2xl  lg:max-w-7xl lg:px-8">
				...
				<div className=" grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
					<div className="relative lg:row-span-2">
						...
						<div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)] ">
					...
					<div className="relative max-lg:row-start-1">
						...
						<div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
							...
							<div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2 mt-4"></div>
						</div>
					...
					<div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
						...
						<div className="relative flex h-50 flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
							<div className="px-8 pt-8 sm:px-10 sm:pt-10">
								<p className="mt-2 text-3xl lg:text-lg/7 font-medium tracking-tight text-blue-700 max-lg:text-center">
									{t("euchallenge3.name")}
								</p>
							...
							<div className="flex flex-1 items-center justify-center @container max-lg:py-6 lg:pb-2 mt-4"></div>
						</div>
						<div className="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-black/5"></div>
					</div>
					<div className="relative lg:row-span-2">
						<div className="absolute inset-px rounded-lg bg-white max-lg:rounded-b-4xl lg:rounded-r-4xl"></div>
						<div className="relative flex h-full flex-col justify-center content-center items-center justify-items-start  overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
							<div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
								<p className="mt-2 text-3xl lg:text-lg/7 font-medium tracking-tight text-blue-700 max-lg:text-center">
									{t("euchallenge4.name")}
								</p>
							...
							<div className="relative min-h-40 w-full grow flex justify-center pb-4">
