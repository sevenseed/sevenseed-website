	...
	return (
		<div className="relative flex flex-auto items-start  pt-10">
			...
			<Container className="flex flex-col gap-4">
				...
				<p>
					This SevenSeed privacy policy governs the collection, storage and
					use of your personal data as, customers, users, members,corporate
					founders, by us, SevenSeed. It provides you with details about the
					personal data we collect from you, how we use it and your rights to
					control personal data we hold about you.
				</p>
				<p>
				...
				<ol className="list-decimal gap-4">
					...
					<p>
						...
						<strong>our Data Protection Officer</strong> by writing to the
						above address or by sending an e-mail to{" "}
						<EmailLink className="text-blue-800" email="dpo@sevenseed.eu" />
					</p>
					<li>
						<strong>
							The personal data we collect about you and the purposes for
							which we collect it:
						</strong>
					</li>
					...
					<p>
						...
						to any third party, except as described in this policy.
					</p>
					<ol>
						<li>
					...
					<p>
						...
						subsidiaries/affiliated companies and to third party processors
						to process personal data on our behalf for the purposes set out
						above. These parties are required to process such information
						based on our instructions and in accordance with this policy.
					</p>
					<p>
						The third party providers to whom we may disclose your personal
						data are:
					</p>
					<ol>
					...
					<p>
						In connection with the above mentioned purposes, we try to avoid
						as much as possible the transfer of personal data that we
						collect from you to third party data processors located outside
						the European Economic Area.
					</p>
					<p>
						When we transfer personal data that we collect from you to third
						party data processors located in countries that are outside of
						the European Economic Area and which do not offer an adequate
						level of protection, we ensure the use of appropriate data
						transfer tools such as the entering into of the standard
					...
					<p>
						You can exercise these rights at any given time by emailing us
						at{" "}
						<EmailLink
