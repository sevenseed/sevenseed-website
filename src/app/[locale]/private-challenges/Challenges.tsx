    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                  ...
                  return (
                    <div key={index} className="relative pl-9">
                      <dt className="inline font-semibold text-gray-900">
                        <IconComponent aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-indigo-600" />
                        {t(`${item.key}.name`)}
                      </dt>{' '}
                      <dd className="inline">{t(`${item.key}.description`)}</dd>
                    </div>
                  );
                })}
              </dl>
          ...
          <Image className='w-full sm:w-[100px] lg:w-[1000px]' alt="" src={strategic} width={1000} />
        </div>
      </div>
    </div>
  );
