				...
				<div className="grid md:grid-cols-2 gap-16 items-center">
					<div>
						<p className="text-lg text-gray-600 mb-8">
							<span className="font-medium">Tired of the noise?</span>{" "}
							Looking for a place where your vision can take root and
							flourish? Europe offers a unique ecosystem for growth,
							collaboration, and impact.
						</p>

						<div className="space-y-6">
							<CheckItem title="Unrivaled Access:">
								2 hours to Paris, London, Amsterdam. Tap into a market
								of 700M+ consumers.
							</CheckItem>
							...
							<CheckItem title="Policy Meets Innovation:">
								Operate at the nexus of EU decision-making. Crucial for
