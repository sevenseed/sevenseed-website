...
function GetStartedForm() {
  ...
  if (state.succeeded) {
    return (
      <div className="flex flex-col rounded-lg p-5 bg-white shadow-lg border border-gray-100 gap-y-3 text-center w-full max-w-3xl mx-auto">
        ...
        <p className="text-gray-600">Our customer support team will get back to you within 1 business day.</p>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <input name="subject" type="hidden" value="Get Started form from Seven Seed" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col space-y-1">
          <label htmlFor="companyName" className="font-medium text-gray-700 text-sm">
            {t("companyName")}
            <RequiredMark />
          </label>
          <input
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="activities" className="font-medium text-gray-700 text-sm">
          {t("activities")}
          <RequiredMark />
        </label>
        <textarea
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="grid grid-cols-2 gap-x-2 gap-y-2">
          <label className="flex items-center space-x-1.5 cursor-pointer">
            <input type="radio" name="region" value="Brussels" className="h-4 w-4 text-blue-600 focus:ring-blue-500" />
            <span className="text-gray-700 text-sm">{t("regions.brussels")}</span>
          </label>
          <label className="flex items-center space-x-1.5 cursor-pointer">
            <input type="radio" name="region" value="Flanders" className="h-4 w-4 text-blue-600 focus:ring-blue-500" />
            <span className="text-gray-700 text-sm">{t("regions.flanders")}</span>
          </label>
          <label className="flex items-center space-x-1.5 cursor-pointer">
            <input type="radio" name="region" value="Wallonia" className="h-4 w-4 text-blue-600 focus:ring-blue-500" />
            <span className="text-gray-700 text-sm">{t("regions.wallonia")}</span>
          </label>
          <label className="flex items-center space-x-1.5 cursor-pointer">
            <input
              type="radio"
            ...
            />
            <span className="text-gray-700 text-sm whitespace-normal">{t("regions.noPreference")}</span>
          </label>
        </div>
        <ValidationError prefix="Region" field="region" errors={state.errors} className="text-red-500 text-xs mt-1" />
      </div>
    ...
    <div className="w-full max-w-5xl mx-auto px-2 sm:px-4 py-6 sm:py-12">
      <div className="flex flex-col gap-y-4 sm:gap-y-6 text-balance w-full">
        <div className="text-center mb-0 sm:mb-2">
          <h1 className="font-display font-extrabold text-slate-900 text-3xl sm:text-5xl mb-2 sm:mb-3">{t("title")}</h1>
          <p className="max-w-3xl mx-auto text-base sm:text-lg text-slate-600">{t("content")}</p>
        </div>
        <GetStartedForm />
      </div>
    </div>
