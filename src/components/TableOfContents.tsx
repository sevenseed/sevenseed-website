...
import { Expandable, ExpandableButton, ExpandableItems } from "@/components/Expandable";
		...
		>
			<Container>
				...
				<p className="mt-4 text-lg tracking-tight text-slate-700">
					...
					highly visual pages designed to teach you everything you need to
					know about icon design with no unnecessary filler.
				</p>
				<Expandable>
